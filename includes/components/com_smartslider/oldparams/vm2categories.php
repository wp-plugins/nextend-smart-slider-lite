...
require_once(JPATH_ADMINISTRATOR . DS . 'components' . DS . 'com_smartslider' . DS . 'oldparams' . DS . 'library' . DS . 'fakeElementBase.php');
require_once(JPATH_ADMINISTRATOR . DS . 'components' . DS . 'com_smartslider' . DS . 'oldparams' . DS . 'vm2Category.class.php');
