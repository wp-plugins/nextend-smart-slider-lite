...
class JElementSliderType extends JElement{
  ...
  function fetchElement($name, $value, &$node, $control_name){
    ...
    $document->addScript(JURI::base().'components/com_smartslider/oldparams/slidertype.js');
        ...
        if ( is_array($themes) ){
          foreach($themes as $theme){
            $GLOBALS['scripts'] = array();
    		    ...
    		    $themeparams->addElementPath(JPATH_ADMINISTRATOR. DS .'components'. DS .'com_smartslider'. DS . 'oldparams');
    ...
    if ( is_array($themes) ){
        ...
        if(defined('DEMO')){
          if(isset($_SESSION[$_REQUEST['module']."_params"])){
    		...
    		$params->addElementPath( JPATH_ROOT . str_replace('/', DS, '/modules/'.$this->_moduleName.'/oldparams') );
