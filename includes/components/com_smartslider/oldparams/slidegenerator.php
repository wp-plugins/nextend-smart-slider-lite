...
class JElementSlideGenerator extends JElement{
  ...
  function fetchElement($name, $value, &$node, $control_name){
    ...
    $document->addScript(JURI::base().'components/com_smartslider/oldparams/slidegenerator.js');
    $document->addStyleSheet( JURI::base().'components/com_smartslider/oldparams/slidegenerator.css' );
