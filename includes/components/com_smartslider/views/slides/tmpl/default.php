...
?>
<form action="index.php?option=com_smartslider&controller=slide" method="post" name="adminForm" id="adminForm">		
  <table>		
    <tr>			
...
<?php
        ...
        <td align="center">						
            [<a href="<?php echo $link; ?>"><b>Edit</b></a>]
          </td>				
        <td align="center">						
          <a href="index.php?option=com_smartslider&controller=slider&task=edit&id=<?php echo $row->slider ?>"><?php echo htmlspecialchars($row->slidername);?></a><br />[<a href="<?php echo JRoute::_( 'index.php?option=com_smartslider&controller=slide&task=add&sliderid='. $row->slider ); ?>"><b><?php echo JText::_('Add new slide'); ?></b></a>]</td>		
				<td class="order">
          <?php if($ordering) : ?>
