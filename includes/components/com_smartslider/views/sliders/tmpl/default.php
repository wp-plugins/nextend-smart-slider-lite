...
?>
<form action="index.php?option=com_smartslider&controller=slider" method="post" name="adminForm" id="adminForm">		
  <table>		
    <tr>			
...
<?php
        ...
        <td align="center">						
          <span style="white-space:nowrap;"><?php echo $row->count;?></span> 
          <span style="white-space:nowrap;">[<a href="<?php echo JRoute::_( 'index.php?option=com_smartslider&controller=slide&task=add&sliderid='. $row->id ); ?>"><b><?php echo JText::_('Add new slide'); ?></b></a>]</span> 
          <span style="white-space:nowrap;">[<a href="<?php echo JRoute::_( 'index.php?option=com_smartslider&controller=slide&filter_slider='. $row->id ); ?>"><b><?php echo JText::_('Show slides'); ?></b></a>]</span> 
        </td>
        <?php
        if(!defined('WP_ADMIN')):
        ?>
