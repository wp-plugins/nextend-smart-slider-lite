...
dojo.declare("SlideLive", null, {
  ...
  show: function(){
    if(this.enabled){
      this.content = dojo.byId('paramcontenthtml');
      this.captionfield = dojo.byId('paramcaptionhtml');
...
dojo.declare("InsertSelector", null, {
  ...
  this.type = type;
    var inputs = dojo.query("#paramstitle, #contenteditor-details input[type=text],  #contenteditor-details textarea, #captioneditor-details input[type=text], #captioneditor-details textarea");   
    dojo.forEach(inputs, function(item, i) {
     ...
     // var ibuttonleft = dojo.create('div', {'class': 'insertbutton_left', 'style': 'margin-top:' + dojo.style(item, 'marginTop') + 'px;'}, item.parentNode.lastChild, 'after');
      var ibuttonleft = dojo.create('div', {'class': 'insertbutton_left'}, item.parentNode, 'after');
      ...
      var rbuttonleft = dojo.create('div', {'class': 'insertbutton_left'}, ibuttonleft, 'after');
  ...
  destroybuttons: function() {
    ...
    var inputs = dojo.query("#contenteditor-details input[type=text],  #contenteditor-details textarea, #captioneditor-details input[type=text], #captioneditor-details textarea");   
    dojo.forEach(inputs, function(item, i) {
      item.ibutton = null;
      item.rbutton = null;
    },this);
