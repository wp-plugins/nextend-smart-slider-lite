...
-------------------------------------------------------------------------*/
?><?php
if(isset($_REQUEST['nextendformrenderer'])){
  if(isset($_REQUEST['key'])){
    ...
    function nextendFixWindowsPath($p){
    ...
    if(isset($_SESSION['theme']) && isset($_SESSION['theme']['forms'][$_REQUEST['key']])){
      $env = $_SESSION['theme'];
      $env['themesdir'] =  nextendFixWindowsPath($env['themesdir']);
      ...
      $origtheme = $theme;
      require_once(nextendFixWindowsPath($_SESSION['NEXTENDADMINPARAMPATH']).DS.'offlajndashboard'.DS.'offlajndashboard.php');
      ...
      $env['typesdir'] =  nextendFixWindowsPath($env['typesdir']);
