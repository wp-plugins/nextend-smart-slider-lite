...
/*        $document =& JFactory::getDocument();
        ...
        DojoLoader::addScriptFile('/administrator/components/com_smartslider/oldparams/specialinsert.js');
   ...
   DojoLoader::addScript('new SpecialInsertConfigurator({ specialinsert: dojo.byId("specialinsert"), url: '.json_encode(JURI::base()).', h: '.json_encode($h).', specialqueries: '.json_encode($specialQueries).', forms: ' .json_encode($forms). ' });');
