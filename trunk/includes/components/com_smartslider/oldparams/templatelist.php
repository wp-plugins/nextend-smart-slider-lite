...
class JElementTemplateList extends JElement{
  ...
  function universalfetchElement($name, $value, &$node){
    ...
    $document->addScript(JURI::base().'components/com_smartslider/oldparams/editor.js');
    $document->addStyleSheet(JURI::base().'components/com_smartslider/oldparams/templatelist.css');
