...
class SliderViewSliders extends JViewLegacy{
	...
	function display($tpl = null){
	  $mainframe = &JFactory::getApplication();
		JToolBarHelper::title(   JText::_( SMARTS?'Slider and Tabber Manager':(SMARTSLIDER?'Slider Manager':'Tabber Manager') ), 'generic.png' );
		JToolBarHelper::deleteList();
    if(version_compare(JVERSION,'3.0.0','ge')){
      JToolBarHelper::addNew();
  		JToolBarHelper::custom( 'duplicate', 'copy.png', 'copy_f2.png', 'Duplicate' );
		}else{
